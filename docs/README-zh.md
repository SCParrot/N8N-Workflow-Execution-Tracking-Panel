...
- ✅ **工作流选择**：支持悬停展开的工作流选择面板，带有"活动指示器"，无缝切换
- ✅ **执行统计**：显示最近 1 小时、6 小时、12 小时、1 天的执行成功/失败次数
- ✅ **执行趋势**：采用"渐变流"设计的 24 小时执行趋势折线图，自动刷新且无动画干扰
- ✅ **执行分布**：玻璃拟态风格的饼图展示不同时间范围内的执行结果分布
- ✅ **现代 UI**：全套玻璃拟态设计系统，包含动态渐变、模糊效果和优质排版（Inter 字体）
...
![桌面视图](../images/desktop-screenshot.webp)

### 移动视图

![移动视图](../images/mobile-screenshot.webp)

## �️ 技术栈

- **前端框架**：Next.js 14.2.3（App Router）
- **可视化库**：ECharts 5.4.3
- **样式方案**：Tailwind CSS 3.4.3（包含自定义玻璃拟态工具类）
- **排版字体**：Inter (Google Fonts)
- **状态管理**：React 18.3.1
- **配置方式**：YAML
- **构建工具**：Next.js Build
- **部署方式**：Docker + PM2
